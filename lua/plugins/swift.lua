...
return {
  {
    ...
    config = function(_, opts)
      ...
      local window_height = math.floor(vim.o.lines * 0.25)
      ...
      map("n", "<leader>Xr", function()
        vim.cmd("botright  split | terminal swift run")
        vim.cmd("resize " .. window_height)
        vim.cmd("setlocal bufhidden=wipe")
        vim.cmd("nnoremap <buffer> q :bdelete!<CR>")
      end, { desc = "Run" })
      ...
      map("n", "<leader>Xt", function()
        vim.cmd("botright  split | terminal swift test 2>&1 | xcbeautify")
        vim.cmd("resize " .. window_height)
        vim.cmd("setlocal bufhidden=wipe")
        vim.cmd("nnoremap <buffer> q :bdelete!<CR>")
      end, { desc = "Test All" })
      ...
      map("n", "<leader>Xc", function()
        vim.cmd("botright  split | terminal swift clean")
        vim.cmd("resize " .. window_height)
        vim.cmd("setlocal bufhidden=wipe")
        vim.cmd("nnoremap <buffer> q :bdelete!<CR>")
      end, { desc = "Clean" })
